...
Перед первым запуском, нужно перейти в папку с проектом DataMatrix.Web (должен быть путь похож на "D:\Repos\DataMatrix\DataMatrix.Web") открыть командную строку и вызвать команды:
